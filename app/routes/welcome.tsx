    ...
    <div className="flex min-h-screen items-center justify-center bg-white dark:bg-zinc-950 px-4 py-8">
      <div className="w-full max-w-[400px] bg-white dark:bg-zinc-950">
        <div className="flex flex-col items-center gap-6">
          ...
          <h1 className="mt-8 text-[28px] font-extrabold text-neutral-900 dark:text-white text-center leading-tight tracking-tight">
            Welcome to READTalk
          </h1>
          ...
          <div className="w-full px-6 pt-4"> {/* px-6 biar ada jeda */}
