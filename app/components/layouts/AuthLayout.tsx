    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className="flex flex-1 overflow-hidden">
                {/* Sidebar - sembunyi di mobile kalo di halaman chat */}
                <div className={`
                    ${isChatPage ? 'hidden md:block' : 'block'} 
                    w-56 px-3 pt-6 border-r border-neutral-200 transition-colors dark:border-neutral-800
                `}>
                    {/* Channels Section */}
                ...
                {/* Main Content - full di mobile kalo di halaman chat */}
